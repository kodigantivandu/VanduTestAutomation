...
{
    class LaunchAppandLogin
    {
        public static void LaunchAppandLogintoApplication()
        {
            Console.WriteLine("Hello, Vandu Writing from TEST-SOMETHING CLASS");
        ...
        public static void SelectSomething(){

            Console.WriteLine("SECOND METHOD: SelectSomething ");
        }
